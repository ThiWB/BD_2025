...
SELECT * FROM PRODUTO WHERE COD_PRODUTO = 3;
 ...
 -- UPDATE, ATUALIZANDO DADOS DE COLUNA EM TABELAS
UPDATE PRODUTO
SET VL_PRODUTO = 45
WHERE COD_PRODUTO = 3;

-- DELETE, EXCLUINDO REGISTROS DE TABELAS
-- NESTE CASO, UMA EXCEÇÃO SERÁ LANÇADA, VIOLAÇÃO DA CONSTRAINT
-- QUE AMARRA O PRODUTO AO ITEM DA NOTA FISCAL
-- NÃO É POSSIVEL EXCLUIR UMA PK QUE TEM DEPENDÊNCIAS EM FK
DELETE FROM PRODUTO
WHERE COD_PRODUTO = 3;
